 ...
 * @ORM\Entity(repositoryClass="WCS\CoavBundle\Repository\ReservationsRepository")
 */
class Reservations
{
    /**
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="publicationDate", type="datetime", unique=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="passenger", type="string", length=32, unique=true)
     */
    private $passenger;
