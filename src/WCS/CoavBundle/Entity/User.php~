...
class User
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="WCS\CoavBundle\Entity\Reservations", inversedBy="passengers")
     ...
     * Add reservation
     *
     * @param \WCS\CoavBundle\Entity\Reservations $reservation
     *
     * @return User
     */
    public function addReservation(\WCS\CoavBundle\Entity\Reservations $reservation)
    {
     ...
     * @param \WCS\CoavBundle\Entity\Reservations $reservation
     */
    public function removeReservation(\WCS\CoavBundle\Entity\Reservations $reservation)
    {
